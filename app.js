const menu = [
  ...
  function createMenuCard(menuItem) {
    ...
    cardElement.style.height = "25rem";
    ...
    cardElement.style.border = "1vh solid #e5e5e5";
    ...
    description.classList.add("card-text"); // Bootstrap class for card text
    ...
    cardElement.addEventListener("mouseover", () => {
      cardElement.style.boxShadow = "0 0 10px 0 rgba(0,0, 0, 0.2), 0 0 10px 0 rgba(0, 0, 0, 0.2)";
      cardElement.style.animation="cardAnimation 1.5s ease-in-out";
      cardElement.style.margin="0";
      cardElement.style.transition="transform scale(1.5)";
      cardElement.style.backgroundColor="black";
      cardElement.style.color="red";

      });
      cardElement.addEventListener("mouseout", () => {
        cardElement.style.boxShadow = "10 0 100px 0 rgba(0,0, 0, 0.2), 0 0 10px 0 rgba(0, 0, 0, 0.2)";
        cardElement.style.animation="none";
        cardElement.style.margin="10px";
        cardElement.style.transition="transform scale(1)";
        cardElement.style.backgroundColor="#f5f5f5";
  ...
  menu.forEach((menuItem) => {
    const card = createMenuCard(menuItem);
